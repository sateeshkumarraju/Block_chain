...
class WalletManager {
    ...
    async connectWallet() {
        ...
        const USE_MOCK_LOCAL = ("TURBOPACK compile-time value", "object") !== "undefined" && localStorage.getItem("useMockContracts") === "true";
        if (USE_MOCK_LOCAL) {
        ...
        try {
            ...
            // Don't set to full mock mode - allow balance checking with real provider
            }
    ...
    async borrowBook(bookId) {
        ...
        if (USE_MOCK_LOCAL || USE_MOCK || !this.libraryContract) {
            console.log("[v0] 🔄 Using Mock Mode (Real contracts not available)");
            // Get book details to check fee
            const book = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$contracts$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockLibraryContract"].getBookDetails(bookId);
            const hash = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$contracts$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockLibraryContract"].borrowBook(this.currentUser, bookId, book.borrowFee);
            console.log("[v0] ✅ MOCK: Book borrowed successfully - Hash:", hash);
            return hash;
        }
        try {
            console.log("[v0] 🔗 METAMASK: Using Real Blockchain Mode");
            console.log("[v0] 🔍 Fetching book details from contract...");
            // Get book details to check fee
            const book = await this.libraryContract.getBook(bookId);
            const borrowFeeInWei = book.borrowFee;
            const borrowFeeInEth = Number(borrowFeeInWei) / 1e18;
            console.log("[v0] 💰 Book Borrow Fee:", borrowFeeInEth, "ETH");
            console.log("[v0] 💵 Fee in Wei:", borrowFeeInWei.toString());
            ...
            if (this.provider) {
                ...
                console.log("[v0] ✅ Wallet Balance:", balanceInEth, "ETH");
                // Estimate gas cost
                console.log("[v0] ⛽ Calculating gas costs...");
                const estimatedGas = await this.libraryContract.borrowBook.estimateGas(bookId, {
                    value: borrowFeeInWei
                });
                const gasPrice = await this.provider.getGasPrice();
                const estimatedGasCost = Number(estimatedGas) * Number(gasPrice);
                const totalCostInEth = borrowFeeInEth + Number(estimatedGasCost) / 1e18;
                console.log("[v0] ⛽ Estimated Gas:", estimatedGas.toString());
                console.log("[v0] 💸 Total Cost (Fee + Gas):", totalCostInEth, "ETH");
                if (balanceInEth < totalCostInEth) {
                    throw new Error(`Insufficient funds. Need ${totalCostInEth.toFixed(4)} ETH, have ${balanceInEth.toFixed(4)} ETH`);
                }
                console.log("[v0] ✅ Sufficient balance confirmed");
            }
            console.log("[v0] ═══════════════════════════════════════════════════════════");
            console.log("[v0] 🚀 SENDING METAMASK CONFIRMATION POPUP...");
            console.log("[v0] ⚠️  METAMASK IS NOW WORKING - POPUP SHOULD APPEAR");
            console.log("[v0] 👆 User must click 'Confirm' in MetaMask to approve payment");
            console.log("[v0] 🛑 Payment will NOT happen until user confirms");
            console.log("[v0] ═══════════════════════════════════════════════════════════");
            // This ALWAYS triggers MetaMask popup for confirmation
            // The transaction is ONLY sent after user confirms
            const tx = await this.libraryContract.borrowBook(bookId, {
                value: borrowFeeInWei
            });
            console.log("[v0] ═══════════════════════════════════════════════════════════");
            console.log("[v0] ✅ METAMASK WORKING - USER CONFIRMED THE PAYMENT!");
            console.log("[v0] 🎉 Transaction successfully sent to blockchain!");
            console.log("[v0] 🔗 Transaction Hash:", tx.hash);
            console.log("[v0] ⏳ Waiting for blockchain confirmation...");
            console.log("[v0] ═══════════════════════════════════════════════════════════");
            // Wait for transaction to be confirmed (1 confirmation)
            const receipt = await tx.wait(1);
            console.log("[v0] ═══════════════════════════════════════════════════════════");
            console.log("[v0] ✅✅ PAYMENT COMPLETE - METAMASK CONFIRMED!");
            console.log("[v0] 💳 Money has been deducted from your wallet");
            console.log("[v0] 📦 Book successfully borrowed");
            ...
            if (error.code === "ACTION_REJECTED") {
                console.log("[v0] ═══════════════════════════════════════════════════════════");
                console.log("[v0] ❌ METAMASK: User rejected the payment confirmation");
                console.log("[v0] 💰 NO MONEY DEDUCTED - Payment cancelled by user");
                console.log("[v0] 🔄 Falling back to mock mode...");
                console.log("[v0] ═══════════════════════════════════════════════════════════");
                const book = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$contracts$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockLibraryContract"].getBookDetails(bookId);
                const hash = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$contracts$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockLibraryContract"].borrowBook(this.currentUser, bookId, book.borrowFee);
                return hash;
                ...
                console.log("[v0] ═══════════════════════════════════════════════════════════");
                console.log("[v0] ❌ METAMASK: Insufficient funds in wallet");
                console.log("[v0] 💰 NO MONEY DEDUCTED - Not enough balance");
                console.log("[v0] 🔄 Falling back to mock mode...");
                console.log("[v0] ═══════════════════════════════════════════════════════════");
                const book = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$contracts$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockLibraryContract"].getBookDetails(bookId);
                const hash = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$contracts$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockLibraryContract"].borrowBook(this.currentUser, bookId, book.borrowFee);
                ...
                console.log("[v0] ═══════════════════════════════════════════════════════════");
                console.log("[v0] ❌ METAMASK: Transaction failed on blockchain");
                console.log("[v0] 📋 Reason:", error.reason);
                console.log("[v0] 🔄 Falling back to mock mode...");
                console.log("[v0] ═══════════════════════════════════════════════════════════");
                const book = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$contracts$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockLibraryContract"].getBookDetails(bookId);
                const hash = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$contracts$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockLibraryContract"].borrowBook(this.currentUser, bookId, book.borrowFee);
                ...
                console.log("[v0] ═══════════════════════════════════════════════════════════");
                console.log("[v0] ❌ METAMASK: Unexpected error");
    ...
    async getBalance() {
        ...
        try {
            // If we have a provider (real wallet), use it
            if (this.provider) {
                try {
                    const balance = await this.provider.getBalance(this.currentUser);
                    const balanceStr = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].formatEther(balance);
                    console.log("[v0] Balance from provider:", balanceStr);
                    return balanceStr;
                } catch (providerError) {
                    console.warn("[v0] Error fetching from provider:", providerError.message);
                // Fall through to mock
                }
            }
            // Fallback to mock (or if no provider)
            console.log("[v0] Using mock balance");
            return "0.0";
        } catch (error) {
...
function useWallet() {
            ...
            const initializeWallet = {
                "useWallet.useEffect.initializeWallet": async ()=>{
                    try {
                        ...
                        const storedAccount = ("TURBOPACK compile-time truthy", 1) ? localStorage.getItem("connectedAccount") : "TURBOPACK unreachable";
                        const wasConnected = ("TURBOPACK compile-time truthy", 1) ? localStorage.getItem("isConnected") === "true" : "TURBOPACK unreachable";
                            ...
                            if (window.ethereum) {
                                try {
                                    ...
                                    if (accounts && accounts.length > 0) {
                                        console.log("[v0] MetaMask reconnected:", accounts[0]);
                                        setAccount(accounts[0]);
                                        setIsConnected(true);
                                    }
                                } catch (err) {
                                    console.log("[v0] Could not auto-reconnect to MetaMask, using stored account");
                                }
                            }
                            return;
                        }
                        // Fall back to getCurrentUser if no localStorage
    ...
    const disconnectWallet = ()=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$wallet$2d$manager$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["walletManager"].disconnectWallet();
        setAccount(null);
        setIsConnected(false);
        setError(null);
    };
...
"[project]/components/transaction-details.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function TransactionDetails() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TransactionDetails.useEffect": ()=>{
            const fetchData = {
                "TransactionDetails.useEffect.fetchData": async ()=>{
                    try {
                        setLoading(true);
            ...
            }["TransactionDetails.useEffect.fetchData"];
            if (isConnected) {
                fetchData();
            }
        }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TransactionDetails.useEffect": ()=>{
            ...
            const interval = setInterval({
                "TransactionDetails.useEffect.interval": async ()=>{
                    try {
                        const [records, userProfile] = await Promise.all([
                            walletManager.getBorrowHistory(),
                            walletManager.getUserProfile()
            ...
            }["TransactionDetails.useEffect.interval"], 2000);
            return ({
                "TransactionDetails.useEffect": ()=>clearInterval(interval)
            })["TransactionDetails.useEffect"];
        }
    }["TransactionDetails.useEffect"], [
        isConnected,
    ...
    if (!isConnected) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                ...
                children: "Connect wallet to view transaction details"
            }, void 0, false, {
                fileName: "[project]/components/transaction-details.tsx",
                lineNumber: 67,
                columnNumber: 9
            }, this)
        }, void 0, false, {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    ...
                                    children: [
                                        totalFeesAccumulated.toFixed(4),
                                        " ETH"
                                    ]
                                }, void 0, true, {
                                    fileName: "[project]/components/transaction-details.tsx",
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                        children: history.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: history.map((record, idx)=>{
                                const borrowDate = new Date(record.borrowDate * 1000);
                                const returnDate = record.returnDate ? new Date(record.returnDate * 1000) : null;
                                const durationDays = record.returnDate ? Math.floor((record.returnDate - record.borrowDate) / (24 * 60 * 60)) : Math.floor((Date.now() / 1000 - record.borrowDate) / (24 * 60 * 60));
                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: `p-3 rounded-lg border ${record.status === "returned" ? "bg-green-50 border-green-200" : record.status === "overdue" ? "bg-red-50 border-red-200" : "bg-yellow-50 border-yellow-200"}`,
                                        ...
                                        children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$badge$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Badge"], {
                                                                className: record.status === "returned" ? "bg-green-200 text-green-800" : record.status === "overdue" ? "bg-red-200 text-red-800" : "bg-yellow-200 text-yellow-800",
                                                                children: record.status === "returned" ? "✓ Completed" : record.status === "overdue" ? "⚠ Overdue" : "Active"
                                                            }, void 0, false, {
                                                                fileName: "[project]/components/transaction-details.tsx",
                                                                lineNumber: 170,
                                                                columnNumber: 27
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    record.status === "returned" && record.fee === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            children: profile.hasLibraryCard ? "✓ Active" : "✗ Not Issued"
                                        }, void 0, false, {
                                            fileName: "[project]/components/transaction-details.tsx",
                                            lineNumber: 227,
                                            columnNumber: 17
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            className: "font-semibold",
                                            children: "Books Currently Borrowed"
                                        }, void 0, false, {
                                            fileName: "[project]/components/transaction-details.tsx",
                                            lineNumber: 230,
                                            columnNumber: 17
...
_s(TransactionDetails, "k0gwNYsstAVeG5q0pA2mwHbadI0=", false, function() {
    return [
...
function WalletConnection() {
    _s();
    const { account, isConnected, isLoading, error, connectWallet, disconnectWallet, walletManager } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$useWallet$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useWallet"])();
                    ...
                    children: [
                        ...
                        error && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                error.includes("not installed") && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
_s(WalletConnection, "SjihCzOKcT5X9kMlNzCGuECEj5g=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$useWallet$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useWallet"]
    ];
});
...
"[project]/components/reports-page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$useWallet$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/useWallet.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$transaction$2d$details$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/transaction-details.tsx [app-client] (ecmascript)");
...
function ReportsPage() {
    _s();
    const { isConnected } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$useWallet$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useWallet"])();
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "min-h-screen bg-gradient-to-b from-purple-50 to-white p-4 md:p-8",
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                                    ...
                                    children: "📊 Transaction & Account Reports"
                                }, void 0, false, {
                                    fileName: "[project]/components/reports-page.tsx",
                                    lineNumber: 19,
                                    columnNumber: 13
                                }, this),
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    className: "text-gray-600",
                                    children: "View your complete transaction history and account statistics"
                                }, void 0, false, {
                                    fileName: "[project]/components/reports-page.tsx",
                                    lineNumber: 20,
                                    columnNumber: 13
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: isConnected ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$transaction$2d$details$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TransactionDetails"], {}, void 0, false, {
                                fileName: "[project]/components/reports-page.tsx",
                                lineNumber: 39,
                                columnNumber: 15
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            children: "Connect your wallet to view transaction reports"
                                        }, void 0, false, {
                                            fileName: "[project]/components/reports-page.tsx",
                                            lineNumber: 43,
                                            columnNumber: 19
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            children: "All your borrowing history, fees, and rewards will be displayed here"
                                        }, void 0, false, {
                                            fileName: "[project]/components/reports-page.tsx",
                                            lineNumber: 44,
                                            columnNumber: 19
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            children: "• Books have a 30-day borrow period"
                                        }, void 0, false, {
                                            fileName: "[project]/components/reports-page.tsx",
                                            lineNumber: 59,
                                            columnNumber: 17
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            children: "• Late fees: 50% per day overdue"
                                        }, void 0, false, {
                                            fileName: "[project]/components/reports-page.tsx",
                                            lineNumber: 60,
                                            columnNumber: 17
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            children: "• On-time return: +10 reward tokens"
                                        }, void 0, false, {
                                            fileName: "[project]/components/reports-page.tsx",
                                            lineNumber: 61,
                                            columnNumber: 17
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            children: "• Maximum 5 books at once"
                                        }, void 0, false, {
                                            fileName: "[project]/components/reports-page.tsx",
                                            lineNumber: 70,
                                            columnNumber: 17
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            children: "• Unlimited transaction history"
                                        }, void 0, false, {
                                            fileName: "[project]/components/reports-page.tsx",
                                            lineNumber: 71,
                                            columnNumber: 17
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            children: "• Unlimited reward tokens"
                                        }, void 0, false, {
                                            fileName: "[project]/components/reports-page.tsx",
                                            lineNumber: 72,
                                            columnNumber: 17
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            children: "• Borrow available books"
                                        }, void 0, false, {
                                            fileName: "[project]/components/reports-page.tsx",
                                            lineNumber: 81,
                                            columnNumber: 17
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            children: "• Return borrowed books"
                                        }, void 0, false, {
                                            fileName: "[project]/components/reports-page.tsx",
                                            lineNumber: 82,
                                            columnNumber: 17
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            children: "• Track all transactions"
                                        }, void 0, false, {
                                            fileName: "[project]/components/reports-page.tsx",
                                            lineNumber: 83,
                                            columnNumber: 17
...
_s(ReportsPage, "q/nR9stHFkDhxwBtpUWNcvwnKIQ=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$useWallet$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useWallet"]
    ];
});
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$reports$2d$page$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/reports-page.tsx [app-client] (ecmascript)");
"use client";
;
;
function Reports() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$reports$2d$page$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ReportsPage"], {}, void 0, false, {
...
//# sourceMappingURL=_cc567e17._.js.map