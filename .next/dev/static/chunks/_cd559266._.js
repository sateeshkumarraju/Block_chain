...
class WalletManager {
    ...
    async borrowBook(bookId) {
        ...
        try {
            ...
            const borrowFeeInEth = Number(book.borrowFee) / 1e18;
            console.log("[v0] Book fee:", borrowFeeInEth, "ETH");
            console.log("[v0] Sending transaction to MetaMask for confirmation...");
            // This will trigger MetaMask popup for confirmation
            const tx = await this.libraryContract.borrowBook(bookId, {
                value: book.borrowFee
            });
            console.log("[v0] Transaction sent to blockchain:", tx.hash);
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                        ...
                        children: [
                            ...
                            book.borrowFee > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "UserProfile.useEffect": ()=>{
            ...
            const interval = setInterval({
                "UserProfile.useEffect.interval": async ()=>{
                    try {
                        const userProfile = await walletManager.getUserProfile();
                        setProfile(userProfile);
                    } catch (err) {
            ...
            }["UserProfile.useEffect.interval"], 1000);
            return ({
                "UserProfile.useEffect": ()=>clearInterval(interval)
            })["UserProfile.useEffect"];
        }
    }["UserProfile.useEffect"], [
        isConnected,
...
_s(UserProfile, "Urg80iWf85FtOoUwGq4BsR/5R24=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$useWallet$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useWallet"]
    ];
});
...
function BorrowHistory({ onReturn }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BorrowHistory.useEffect": ()=>{
            if (!isConnected) return;
            const interval = setInterval({
                "BorrowHistory.useEffect.interval": async ()=>{
                    try {
                        const records = await walletManager.getBorrowHistory();
                        setHistory(records);
                    } catch (err) {
            ...
            }["BorrowHistory.useEffect.interval"], 2000);
            return ({
                "BorrowHistory.useEffect": ()=>clearInterval(interval)
            })["BorrowHistory.useEffect"];
        }
    }["BorrowHistory.useEffect"], [
        isConnected,
...
_s(BorrowHistory, "opOp7/3EqyLDhT8504+hj9bfM3M=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$useWallet$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useWallet"]
    ];
});
...
"[project]/components/transaction-tracker.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function TransactionTracker({ transactions = [] }) {
    _s();
    const [displayedTx, setDisplayedTx] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TransactionTracker.useEffect": ()=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "space-y-3",
                    children: displayedTx.map((tx, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                tx.bookTitle && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    children: [
                                                        "• ",
                                                        tx.bookTitle
                                                    ]
                                                ...
                                                tx.fee !== undefined && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    children: [
                                                        "• Fee: ",
                                                        tx.fee.toFixed(4),
                                                        " ETH"
                                ...
                                tx.explorerUrl && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
                                    href: tx.explorerUrl,
                                    target: "_blank",
...
_s(TransactionTracker, "3X4r5Sw8HXf3GFG98vjgIAkEtmo=");
_c = TransactionTracker;
var _c;
__turbopack_context__.k.register(_c, "TransactionTracker");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$transaction$2d$tracker$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/transaction-tracker.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function LibraryDashboard() {
    ...
    const handleBorrow = async (bookId, title)=>{
        ...
        try {
            ...
            showNotification("success", `📝 Confirm payment in MetaMask to borrow "${title}"...`);
            ...
            if (err.message.includes("rejected")) {
                errorMsg = "❌ Payment cancelled - transaction rejected";
            } else if (err.message.includes("Insufficient")) {
                errorMsg = "❌ Insufficient funds to pay the borrow fee";
            }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LibraryDashboard.useEffect": ()=>{
            ...
            const interval = setInterval({
                "LibraryDashboard.useEffect.interval": ()=>{
                    setRefreshKey({
                        "LibraryDashboard.useEffect.interval": (k)=>k + 1
                    }["LibraryDashboard.useEffect.interval"]);
                }
            }["LibraryDashboard.useEffect.interval"], 1500);
            return ({
                "LibraryDashboard.useEffect": ()=>clearInterval(interval)
            })["LibraryDashboard.useEffect"];
        }
    }["LibraryDashboard.useEffect"], []);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                transactions.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$transaction$2d$tracker$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TransactionTracker"], {
...
_s(LibraryDashboard, "IQlfm78999eTaMrSknFC53zcyO0=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$useWallet$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useWallet"]
    ];
});
...
//# sourceMappingURL=_cd559266._.js.map